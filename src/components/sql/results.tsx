...
export function ResultsPanel({
  ...
  if (isLoading) {
    return (
      <div
        className={cn('border-t shadow-xl', className)}
        style={{ maxHeight }}
      >
        {/* Results toolbar - 24px height */}
        <div className="flex items-center justify-between px-3 h-6 bg-background text-foreground">
        ...
        {/* Loading content */}
        <div className="overflow-y-auto bg-background text-foreground" style={{ maxHeight: `calc(${maxHeight} - 24px)` }}>
          <div className="flex items-center justify-center min-h-[200px] ">
            <div className="text-center">
              <div className="flex items-center justify-center w-16 h-16 /30 rounded-full mb-4 mx-auto">
  ...
  if (error) {
    return (
      ...
      >
        {/* Results toolbar - 24px height */}
        <div className="flex items-center justify-between px-3 h-6 bg-destructive/10 border-destructive/20">
          <div className="flex items-center gap-3 text-xs">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  {(error.line || error.column) && (
                    <div className="text-xs  /50 p-3 rounded-sm">
  ...
  if (!result) {
    return (
      <div
        className={cn('shadow-xl bg-background text-foreground', className)}
        style={{ maxHeight }}
      >
        {/* Results toolbar - 24px height */}
        <div className="flex items-center justify-between px-3 h-6 border-b border-t">
          <div className="flex items-center gap-3 text-xs">
        ...
        <div className="overflow-y-auto" style={{ maxHeight: `calc(${maxHeight} - 24px)` }}>
          <div className="flex items-center justify-center min-h-[200px] ">
            <div className="text-center">
              ...
              <p className="text-sm  max-w-md px-8">
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between px-3  h-6  ">
          <div className="flex items-center gap-3 text-xs">
            <span className="font-medium ">0 rows returned</span>
            {result.columns && (
              <span className="">
        ...
        <div className="overflow-y-auto" style={{ maxHeight: `calc(${maxHeight} - 24px)` }}>
          <div className="flex items-center justify-center min-h-[150px] bg-gradient-to-b from-background to-muted/10">
            <div className="text-center">
              <div className="flex items-center justify-center w-12 h-12 /30 rounded-full mb-3 mx-auto">
  ...
  return (
    <div
      className={cn('border-t /95 backdrop-blur-sm shadow-xl', className)}
      style={{ maxHeight }}
    >
      {/* Results summary toolbar - 24px height */}
      <div className="flex items-center justify-between px-3  /50 h-6">
        <div className="flex items-center gap-3 text-xs">
        ...
        <Table>
          ...
          <TableBody>
            {result.data.map((row: Record<string, unknown>, rowIndex: number) => (
              <TableRow key={rowIndex} className="hover:/50">
...
function CellValue({
  ...
  if (value === null || value === undefined) {
    return <span className=" italic">NULL</span>
  }
