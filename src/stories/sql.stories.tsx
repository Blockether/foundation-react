...
const mockAnalyticalQueries = [
  {
    ...
    query: 'SELECT COUNT(*) as total_rows, AVG(id) as avg_id, MAX(id) as max_id, MIN(id) as min_id FROM users;',
    icon: '📊',
  ...
  },
  {
    ...
    query: 'SELECT name, COUNT(*) as frequency FROM users WHERE name IS NOT NULL GROUP BY name ORDER BY frequency DESC LIMIT 10;',
    icon: '🏆',
        ...
        helpContent={
          <div className="p-4">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              This comprehensive demo showcases analytical queries with intelligent targeting and automatic chart generation.
            </p>
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <ul className="space-y-1 ml-4 text-muted-foreground">
                  <li>• Click the <strong>Database icon</strong> in toolbar to see data sources</li>
                  <li>• Each data source shows relevant analytical queries based on targeting rules</li>
                  <li>• Click the <strong>Chart icon</strong> next to data sources to run analytical queries</li>
                  <li>• Charts are automatically generated from query results</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 ml-4 text-muted-foreground">
                  <li>• <strong>Summary Statistics</strong> - Bar charts for counts and averages</li>
                  <li>• <strong>Data Profiling</strong> - Quality metrics and completeness charts</li>
                  <li>• <strong>Top Values</strong> - Frequency distribution charts</li>
                  <li>• <strong>Data Distribution</strong> - Pattern analysis visualizations</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 ml-4 text-muted-foreground">
                  <li>• <strong>Summary Statistics</strong> - targets tables and files</li>
                  <li>• <strong>Data Profiling</strong> - targets tables and views</li>
                  <li>• <strong>Top Values</strong> - only targets specific tables (users, products)</li>
                  <li>• <strong>Data Distribution</strong> - targets only tables</li>
                </ul>
              </div>

              <div className="p-3 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded">
                <p className="text-xs font-medium text-blue-800 dark:text-blue-200">
                  💡 Tip: Try different analytical queries to see various chart types!
                </p>
              </div>
            </div>
          </div>
...
export const FailedDataSources: Story = {
    ...
    const failedDataSources: DataSource[] = [
      {
        ...
        loadingError: 'CSV parsing error: Invalid format on line 42. Expected 3 columns but found 5.'
      },
      {
        id: '2',
        ...
        createdAt: new Date('2023-01-15'),
        loadingStatus: 'failed',
        loadingError: 'HTTP 404: File not found at /.storybook/dataset/nonexistent.parquet'
      },
      {
        id: '3',
        ...
        createdAt: new Date('2023-02-01'),
        loadingStatus: 'failed',
        loadingError: 'JSON parsing error: Unexpected token } in JSON at position 1234'
      },
      {
        id: '4',
        ...
        loadingStatus: 'failed',
        loadingError: 'Processing timeout: File exceeds maximum processing time of 30 seconds'
      },
      {
        id: '5',
        name: 'Working Data',
      ...
      <SQLCockpit
        ...
        helpContent={
          <div className="p-4">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              This story demonstrates error handling for failed data source imports.
            </p>
            <div className="space-y-3 text-sm">
              <div>
                <p className="font-medium mb-1">🔍 Error Indicators:</p>
                <ul className="space-y-1 ml-4 text-muted-foreground">
                  <li>• <strong>Red X</strong> - Failed data sources show error status</li>
                  <li>• <strong>Hover</strong> - Mouse over error icons for details</li>
                  <li>• <strong>Remove Button</strong> - Failed sources can be removed</li>
                  <li>• <strong>Disabled</strong> - Failed sources are not selectable</li>
                </ul>
              </div>
              <div>
                <p className="font-medium mb-1">📋 Common Error Types:</p>
                <ul className="space-y-1 ml-4 text-muted-foreground">
                  <li>• <strong>CSV Parsing</strong> - Invalid file format or structure</li>
                  <li>• <strong>File Not Found</strong> - Missing files or wrong URLs</li>
                  <li>• <strong>JSON Errors</strong> - Malformed JSON data</li>
                  <li>• <strong>Timeout</strong> - Files too large to process</li>
                </ul>
              </div>
              <div className="p-3 bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded">
                <p className="text-xs">
                  <strong>Note:</strong> One data source loads successfully to show mixed success/failure scenarios.
                </p>
              </div>
            </div>
          </div>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates comprehensive error handling for failed data source imports. Shows various error states (CSV parsing errors, missing files, JSON corruption, timeouts) with visual indicators, error details on hover, and the ability to remove failed sources. One successful data source is included to demonstrate mixed scenarios.'
      }
    }
  }
}
