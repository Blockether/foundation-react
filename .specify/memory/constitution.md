...
- Templates requiring updates: ⚠ All template files need validation against new principles
- Follow-up TODOs: Verify shadcn/ui integration setup
-->

# @blockether/foundation-react Constitution
