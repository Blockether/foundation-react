...
const meta: Meta<typeof SQLCockpit> = {
  ...
  argTypes: {
    ...
    showHelp: {
      control: 'boolean',
      description: 'Whether to show help button',
    },
    helpContent: {
      control: 'object',
      description: 'Custom help content to display in help modal',
    },
    editorMinHeight: {
      control: 'text',
      description: 'Minimum height for editor area',
    },
    resultsMaxHeight: {
      control: 'text',
      description: 'Maximum height for results area',
    },
  },
  decorators: [
